    ...
    <div class='modal-control'>
        ...
        <div class='d-flex justify-content-center'>
            <div id='modal-add' class='modal-content'>
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button onclick="new_category()" class="btn btn-primary px-5 py-3 mx-2">Add</button>
                </div>
            </div>
        </div>
        ...
        <div class='d-flex justify-content-center'>
            <div id='modal-edit' class='modal-content'>
                ...
                <div class="d-flex justify-content-end">
                    <button onclick="close_modal()" class="btn btn-primary px-5 py-3 mx-2">Cancel</button>
                    <button onclick="edit_category()" class="btn btn-primary px-5 py-3 mx-2">Edit</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="d-flex justify-content-start">
    ...
    <div>
        ...
        <div class='view-main' style='overflow:auto;'>
            <h1 class='h1'>Categories of Business</h1><br>
...
<script>
    ...
    function confirm_remove(id){
        if(confirm("Do you wish to delete this category?")){
            window.location.href = "<?php echo site_url("settings/remove_category")."/";?>" + id;
        }
    }
    ...
    function search(){
        ...
        window.location.href = '<?php echo site_url("settings/categories")?>/?search='+usearch;
    }

    function new_category(){
        $.post('<?php echo site_url('settings/add_category');?>',{
    ...
    function edit_category(){
        if(selected != -1){
            $.post('<?php echo site_url('settings/edit_category');?>'+'/'+selected,{
